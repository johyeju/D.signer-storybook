...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    컴포넌트와 UI 요소를 체계적으로 정리하고, 누구나 쉽게 참고할 수 있도록 만들었습니다.
  ...
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      <p className="sb-section-item-paragraph">웹 애플리케이션과 마찬가지로 스토리북에도 CSS를 포함하는 방법은 다양합니다.</p>
      <a
...
<div className="sb-addon">
  <div className="sb-addon-text">
    ...
    <a href="https://storybook.js.org/addons/" target="_blank">
      Discover all addons
      <RightArrow />
    </a>
  </div>
