      ...
      >
        ...
        <g transform="translate(12, 12)">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <g id="Group 1410167199">
              <path
                id="Vector 22571"
                d="M18.486 8.6409H1.57841C1.28696 8.6409 1.08244 8.9282 1.17785 9.20359L3.85993 16.9455C3.91906 17.1162 4.07986 17.2307 4.2605 17.2307H16.0103C16.1946 17.2307 16.3579 17.1115 16.414 16.9359L18.8898 9.19395C18.9773 8.92042 18.7732 8.6409 18.486 8.6409Z"
                fill="#FFFFFF"
              />
              <path
                id="Union"
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M0.378669 4.3459H3.92348L8.14562 0.123754C8.31063 -0.0412516 8.57815 -0.0412514 8.74316 0.123755L9.27585 0.656449C9.44086 0.821455 9.44086 1.08898 9.27585 1.25399L6.18394 4.3459H13.8694L10.7775 1.25399C10.6125 1.08898 10.6125 0.821455 10.7775 0.656449L11.3102 0.123755C11.4752 -0.0412514 11.7427 -0.0412516 11.9077 0.123754L16.1299 4.3459H19.6376C19.8926 4.3459 20.0747 4.59306 19.999 4.83666L19.3537 6.91459C19.3045 7.07293 19.158 7.18084 18.9922 7.18084H0.86266C0.686696 7.18084 0.533941 7.05957 0.494024 6.8882L0.0100335 4.81026C-0.0452552 4.57289 0.134942 4.3459 0.378669 4.3459Z"
                fill="#FFFFFF"
              />
            </g>
          </svg>
